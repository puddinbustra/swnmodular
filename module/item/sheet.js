...
// Potential consumption targets
  ...
  _onConfigureTraits(event) {
    ...
    switch(a.dataset.options) {
      case "saves":
        options.choices = CONFIG.SWNPRETTY.abilities;
        options.valueKey = null;
        break;
      case "skills.choices":
        options.choices = CONFIG.SWNPRETTY.skills;
        options.valueKey = null;
        break;
      case "skills":
        const skills = this.item.data.data.skills;
        const choiceSet = skills.choices?.length ? skills.choices : Object.keys(CONFIG.SWNPRETTY.skills);
        options.choices = Object.fromEntries(Object.entries(CONFIG.SWNPRETTY.skills).filter(([skill,]) => choiceSet.includes(skill)));
