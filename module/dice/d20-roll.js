...
export default class D20Roll extends Roll {
   ...
   * @type {string}
   */
  static EVALUATION_TEMPLATE = "systems/swnpretty/templates/chat/roll-dialog.html";
  ...
  async toMessage(messageData={}, options={}) {
    ...
    // Add appropriate advantage mode message flavor and SWN roll flags
  ...
  _onDialogSubmit(html, advantageMode) {
    ...
    if ( form.ability?.value ) {
      ...
      this.options.flavor += ` (${CONFIG.SWNPRETTY.abilities[form.ability.value]})`;
    }
