...
export default class ActiveEffect5e extends ActiveEffect {
  ...
  determineSuppression() {
    ...
    this.isSuppressed = itemData.equipped === false || (itemData.attunement === CONFIG.SWNPRETTY.attunementTypes.REQUIRED);
  }
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("SWNPRETTY.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("SWNPRETTY.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("SWNPRETTY.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("SWNPRETTY.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("SWNPRETTY.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("SWNPRETTY.EffectUnavailableInfo")]
      }
    };
